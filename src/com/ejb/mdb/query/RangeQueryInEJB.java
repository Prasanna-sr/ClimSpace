...
@Stateless
@Remote(RangeQueryIn.class)
public class RangeQueryInEJB implements RangeQueryIn {
	...
	public void getRangeData( String[] aRow) {
		System.out.println("RangeQueryInEJB in update String[]: " );		
	...
	private void sendMessage(String msg, String[] msgArr, boolean isText) {
		...
		try {
			Queue queue = (Queue) ctx.lookup("query/in");
